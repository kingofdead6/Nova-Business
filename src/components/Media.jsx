      ...
      <div ref={inner} className="absolute inset-0 h-full w-full scale-[1.12]">
        {src ? (
          <img
            ...
            loading="lazy"
            /*
             * `tone="dark"` signale une image posée sur le ciel : elle reçoit
             * le refroidissement des gravures sépia (voir .engrave-cool). La
             * correction est donc portée par le ton déclaré, et non répétée
             * sur chaque appel — une image passée en sombre ne peut plus
             * arriver brune sur le bleu par oubli.
             */
