      ...
      >
        <div
          className={`relative flex items-center justify-between rounded-full py-2 pl-4 pr-2 transition-all duration-500 ease-nova md:pl-6 ${
            solid
              ? "bg-ivoire/85 shadow-[0_10px_40px_-18px_rgba(23,26,46,0.5)] backdrop-blur-md"
              : "bg-ivoire/75 backdrop-blur-sm"
          }`}
        >
          <a
            href="#top"
          ...
          >
            <svg viewBox="0 0 120 120" className="h-7 w-7" fill="none" aria-hidden="true">
              <path d="M96 34a48 48 0 1 0 -6 62" stroke="#3A4680" strokeWidth="6" strokeLinecap="round" />
              <path
                ...
                strokeLinecap="round"
              />
              <path d="M88 30l3 8 8 3-8 3-3 8-3-8-8-3 8-3z" fill="#C8B88A" />
            </svg>
